    ...
    def extract_results(text)
      ...
      lines.each_with_index do |line, index|
        ...
        if in_results_section && current_division && line.match?(/^\s*\d+\s+/)
          ...
          parsed_results = parse_pine_valley_result_line_with_splits(line, current_division)
        ...
        rider_numbers.each_with_index do |rider_number, idx|
          ...
          if place_match
            ...
            if place_start
              ...
              result = parse_pine_valley_result_line(clean_racer_line, division)
